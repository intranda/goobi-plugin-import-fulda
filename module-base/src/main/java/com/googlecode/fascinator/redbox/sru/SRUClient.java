...
//
//import de.intranda.goobi.plugins.FuldaNewspaperImport;
//
///**
// * <p>
...
//    /** Logging **/
//    protected static final Logger log = Logger.getLogger(FuldaNewspaperImport.class);
//
...
//     * @return String A URL that can be retrieved to execute this search.
//     */
//    public final String generateSearchUrl(String query, String operation) {
...
//     * @return String A URL that can be retrieved to execute this search.
//     */
//    public final String generateSearchUrl(String query, String operation, String sortKeys) {
...
//     * @return String A URL that can be retrieved to execute this search.
//     */
//    public final String generateSearchUrl(String query, String operation, String sortKeys, String startRecord, String maxRecords) {
...
//     */
//    public final SRUResponse getResponseObject(String xmlData) {
//        // Parsing
...
//     */
//    public final List<Node> getResultList(String xmlData) {
...
//     */
//    public final String getSearchResponse(String query) {
...
//     * @return String The response body return from the SRU interface.
//     */
//    public final String getSearchResponse(String query, String operation) {
...
//     * @return String The response body return from the SRU interface.
//     */
//    public final String getSearchResponse(String query, String operation, String sortKeys) {
...
//     * @return String The response body return from the SRU interface.
//     */
//    public final String getSearchResponse(String query, String operation, String sortKeys, String startRecord, String maxRecords) {
...
//                log.error("Error access SRU interface, status code "+ status + " returned with message: "  + text);
//                return null;
//            }
//
...
//    /**
//     * <p>
//     * Get the requested URL and return the GetMethod Object afterwards. To access more info use its method: eg. GetMethod.getStatusCode() and
//     * GetMethod.getResponseBodyAsString()
//     * </p>
//     * 
//     * <p>
//     * Internally wraps a Fascinator BasicHttpClient Object, so any configured proxy details from the system will be used automatically.
//     * </p>
//     * 
//     * @param url The URL to retrieve
//     * @return GetMethod The instantiated and executed GetMethod Object.
//     * @throws IOException If any network errors occur accessing the URL. Note this does not cover HTTP errors returned from the web server; use the
...
//     */
//    public final List<NLAIdentity> nlaGetIdentitiesBySearch(String search) {
...
//     * @return List<NLAIdentity> A list of processed Identities
//     */
//    public final List<NLAIdentity> nlaGetIdentitiesBySearch(String search, String startRecord, String maxRecords) {
...
//     */
//    public final NLAIdentity nlaGetIdentityById(String id) throws SRUException {
...
//     */
//    public final String nlaGetNationalId(String id) {
//        Node node = nlaGetRecordNodeById(id);
//
//        if (node == null) {
//            return null;
...
//     * @return String The record matching this identifier. Null if not found
//     */
//    public final String nlaGetRecordById(String id) {
//        Node node = nlaGetRecordNodeById(id);
//
//        if (node == null) {
//            return null;
...
//     */
//    public final SRUResponse nlaGetResponseBySearch(String search) {
...
//     * @return SRUResponse A parsed response
//     */
//    public final SRUResponse nlaGetResponseBySearch(String search, String startRecord, String maxRecords) {
//        nlaNamespaces();
//
//        // Search NLA
...
//     */
//    public final Document parseXml(String xmlData) {
//        try {
...
//     */
//    public final void setPacking(String newPacking) {
...
//     */
//    public final void setRecordSchema(String newSchema) {
...
//     */
//    public final void testResponseResource(String fileName) throws IOException {
