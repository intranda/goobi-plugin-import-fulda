...
///**
// * <p>
// * A basic wrapper for handling EAC-CPF formatted identities that return for the National Library of Australia. This is neither a complete EAC-CPF
// * handling class, nor a complete implementation of NLA identities. It is just a utility for access the things ReDBox/Mint cares about in common node.
// * </p>
// * 
...
//    /**
//     * <p>
//     * Converts a List of DOM4J Nodes into a List of processed NLAIdentity(s). Individual Nodes that fail to process will be skipped.
//     * </p>
//     * 
...
//    /**
//     * <p>
//     * Converts a List of DOM4J Nodes into a List of processed NLAIdentity(s). Must indicate whether or not errors should cause processing to halt.
//     * </p>
//     * 
//     * @param nodes A List of Nodes to process
...
//     */
//    public static List<NLAIdentity> convertNodesToIdentities(List<Node> nodes, boolean haltOnErrors) throws SRUException {
...
//                    || "National Library of Australia Party Infrastructure".equals(institution) || "Libraries Australia".equals(institution)) {
...
//    /**
//     * <p>
//     * Getter for the List of Identities observed for this person. The return Objects are Maps containing keys very similar to the methods found on
//     * the top-level NLAIdentity Object.
//     * </p>
//     * <ul>
//     * <li>'displayName'</li>
//     * <li>'firstName'</li>
...
//     */
//    public final List<Map<String, String>> getKnownIdentities() {
//        return knownIds;
//    }
//
...
//            if ((oldDisplayName == null) || ((thisDisplayName != null) && (thisDisplayName.length() > oldDisplayName.length()))) {
//                // Clear any old data
//                idMap.clear();
//                // Store this ID
//                idMap.putAll(name);
